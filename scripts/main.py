...
from model import train_logistic_regression_model_with_grid_search
...
# 2. Trening i optymalizacja modelu Logistic Regression z GridSearchCV
best_model, best_params = train_logistic_regression_model_with_grid_search(X_train, y_train)
