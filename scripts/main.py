...
from model import optimize_lightgbm_with_optuna
...
# 2. Trening i optymalizacja modelu LightGBM z Optuna
best_model, best_params = optimize_lightgbm_with_optuna(X_train, y_train)
