...
from model import optimize_logistic_regression_with_random_search
...
# 2. Trening i optymalizacja modelu Logistic Regression z RandomizedSearchCV
best_model, best_params = optimize_logistic_regression_with_random_search(X_train, y_train)
