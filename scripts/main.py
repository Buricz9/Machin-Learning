...
from model import train_random_forest_model_with_random_search
...
# 2. Trening i optymalizacja modelu Random Forest z RandomizedSearchCV
best_model, best_params = train_random_forest_model_with_random_search(X_train, y_train)
