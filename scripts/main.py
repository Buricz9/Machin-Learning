...
from model import train_svm_model_with_optuna
...
# 2. Trening i optymalizacja modelu SVM z Optuna
best_model, best_params = train_svm_model_with_optuna(X_train, y_train)
