...
from model import train_svm_model_with_grid_search
...
# 2. Trening i optymalizacja modelu SVM z GridSearchCV
best_model, best_params = train_svm_model_with_grid_search(X_train, y_train)
